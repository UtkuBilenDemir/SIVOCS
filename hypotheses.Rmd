...
```{r FamTrans, echo=FALSE, fig.align='center', fig.height=4, fig.retina=2, fig.width=12, message=FALSE, warning=FALSE, dev='svg', include=TRUE}
...
```{r }
corr.test(feat_df.num$transdisciplinaryExp.rate., ad_df$d13, use = "pairwise.complete.obs", method = "spearman")
```
...
```{r Acage_bar, echo=FALSE, fig.width=8, fig.height=4, dev='svg', fig.retina=2, fig.align='center'}
...
```{r D1-likert, echo=FALSE, fig.width=12, fig.height=4 , fig.retina=2, fig.align='center', dev='CairoSVG'}
d1.df_named <- d1.df
names(d1.df_named) <- c(
...
```{r E1-Involvement, echo=FALSE, fig.width=12, fig.height=6 , fig.retina=2, fig.align='center', dev='CairoSVG'}
...
```{r E2-Nature, echo=FALSE, fig.width=12, fig.height=6 , fig.retina=2, fig.align='center',  dev='CairoSVG'}
...
```{r G1_bar, echo=FALSE, fig.width=12, fig.height=6 , fig.retina=2, fig.align='center',  dev='CairoSVG'}
g1.df_named <- g1.df
names(g1.df_named) <- 
  c(
...
## cormat <- round(cor(eg_df, use = "pairwise.complete.obs", method = "spearman" ),2)
## library(reshape2)
...
## 
## ggheatmap + 
## geom_text(data = melted_cormat, aes(Var1, Var2, label = value), color = "black", size = 4) +
## theme(
...
## 
## library(ggcorrplot)
## ggcorrplot(cormat, type = "lower", lab = T,
##    outline.col = "white",
...
```{r G6_bar, echo=FALSE, fig.width=12, fig.height=6 , fig.retina=2, fig.align='center',  dev='CairoSVG'}
g6.df_named <- g6.df
names(g6.df_named) <- 
  c(
    Impactstatements.capab. = "The targeted groups have likely gained capabilities to tackle similar issues.",
    Impactstatements.emanc. = "The project played an emancipatory role",
    Impactstatements.understanding. = "The project generated a better understanding of a  social issue.",
    Impactstatements.mitig. = "The project contributed to the mitigation of a social issue.",        
    Impactstatements.unknown. = "The project results addressed an issue that was not (widely) known before.",       
...
```{r}
# corr.test(gd_df, use = "pairwise.complete.obs", method = "spearman")
```
