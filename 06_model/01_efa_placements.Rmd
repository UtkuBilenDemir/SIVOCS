...
```{r, out.width="0.3\\linewidth", include=TRUE, fig.align="center", fig.cap=c("SI Characteristics"), echo=FALSE}
...
```{r, out.width="0.3\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Removed Variables"), echo=FALSE}
...
```{r, out.width="0.3\\linewidth", include=TRUE, fig.align="center", fig.cap=c("EFA Factors"), echo=FALSE}
...
The final model structure to be fed into the confirmatory factor analysis has been decided with the consideration of both the results of the exploratory factor analysis and the initial theory driven structure presented above. 
...
Model structure:
```{r, out.width="0.3\\linewidth", include=TRUE, fig.align="center", fig.cap=c("CFA Model, Factors 1-3"), echo=FALSE}
knitr::include_graphics("../06_model/factor123.pdf")
```
```{r, out.width="0.3\\linewidth", include=TRUE, fig.align="center", fig.cap=c("CFA Model, Factors 4-6"), echo=FALSE}
knitr::include_graphics("../06_model/factor456.pdf")
```
```{r, out.width="0.3\\linewidth", include=TRUE, fig.align="center", fig.cap=c("CFA Model, Factors 7-8"), echo=FALSE}
...
1. How to reason the legitimacy of the model?
2. How/if should we reduce the model to its most important elements?
3. How to describe the model numerically?
4. Should we also go for "prediction"?
