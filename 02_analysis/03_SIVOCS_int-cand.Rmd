...
##data$cocreation <- factor(data$natureOfInvolvement.citiz. == "cocr")
##cocr <- ggplot(data=data, aes(x=motivation.welfare., y=groupsInvolved.citiz., color=cocr))+
##  geom_point()+
##  geom_smooth(method="lm") 
##collab <- ggplot(data=data, aes(x=motivation.welfare., y=groupsInvolved.citiz., color=collab))+
##  geom_point()+
##  geom_smooth(method="lm") 
